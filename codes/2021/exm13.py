...
# 
# Shows how to create simple geometry from splines and ellipse arcs, and how to
# mesh a quad mesh in GmshMesher. 
# Also demonstrates drawGeometry(), drawMesh, and drawing texts and labels in a
# figure. 
...
cfv.figure(fig_size=(10,10))
cfv.draw_nodal_values_contourf(a, coords, edof, title="Temperature", 
                               dofs_per_node=mesh.dofs_per_node, 
                               el_type=mesh.el_type, draw_elements=True)
cfv.colorbar()
